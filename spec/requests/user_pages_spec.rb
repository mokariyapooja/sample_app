...
describe "User pages" do
    ...
    describe "following/followers" do
        ...
        describe "followed users" do
            before do
                ...
                it { should_not have_selector('title', text: full_title('Following')) }
        ...
        describe "followers" do
            before do
                ...
                it { should_not have_selector('title', text: full_title('Followers')) }
        ...
        describe "follow/unfollow buttons" do 
            ...
            describe "following a user" do 
                ...
                describe "toggling the button" do
                    ...
                    #find_field('commit').value.should eq 'Unfollow'
           ...
           it {should_not have_selector('div.pagination')  }
            it "should list each user" do
                User.paginate(page: 1).each do |user|
                     #User.paginate(page: 1, :per_page => 1).each do |user|
	...
	describe "signup" do
		...
		describe "with invalid information" do
			...
			describe "with the valid information" do
				before do
    ...
    describe "edit" do
        ...
        describe "with valid information" do
    		...
    		it {should_not have_selector('title',text: new_name)}
